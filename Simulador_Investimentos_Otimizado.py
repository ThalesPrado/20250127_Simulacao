...
# Carregar as configurações do arquivo funcoes.env
config = Config(RepositoryEnv("funcoes.env"))

# Função de autenticação usando funcoes.env
def autenticar_usuario(usuario, senha):
    usuario_valido = config("USUARIO")
    senha_valida = config("SENHA")
